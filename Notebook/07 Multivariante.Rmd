...
place = sample(c("San Francisco", "Barcelona", "Valencia", "Cobija", 
                 "Asturias"), size = 100, replace = TRUE)
...
Relativa Marginal por la combinacion sexo y país.
...
```{r}
prop.table(table(sex, ans, place), margin = c(1,2)) #Frec Rel Marginal por Sexo y País
```
